    ...
    <div class="max-w-4xl mx-auto px-4 space-y-1">
        <p class="text-gray-300">
            ...
            <a 
                ...
                class="text-green-400 hover:text-green-300 transition-colors duration-200 hover:underline"
                target="_blank"
        ...
        <p class="text-gray-400">
            <a 
                href="https://github.com/ewanc26/atproto-snake" 
                target="_blank" 
                rel="noopener noreferrer" 
                class="text-green-400 hover:text-green-300 transition-colors duration-200 hover:underline inline-flex items-center space-x-1"
            >
            ...
            <span class="text-gray-500 text-xs">MIT License</span>
            <span class="text-gray-500 mx-2">•</span>
            <a 
